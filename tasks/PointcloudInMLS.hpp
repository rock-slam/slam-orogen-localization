...
#ifndef LOCALIZATION_POINTCLOUDINMLS_TASK_HPP
#define LOCALIZATION_POINTCLOUDINMLS_TASK_HPP
...
namespace localization {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','localization::PointcloudInMLS')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    class PointcloudInMLS : public PointcloudInMLSBase
    {
    ...
    public:
         ...
         */
        PointcloudInMLS(std::string const& name = "localization::PointcloudInMLS");
         ...
         * 
         */
        PointcloudInMLS(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of PointcloudInMLS
         */
	~PointcloudInMLS();
